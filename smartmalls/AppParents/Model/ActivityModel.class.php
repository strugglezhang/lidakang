...
class ActivityModel extends Model
{
    ...
    public function get_app_list($state, $keyword, $page = '1,10', $fields = null)
    {
        ...
        return $this->field('id,name,img,start_time,end_time,type,host_id')->where($condition)->page($page)->select();
    }
    ...
    public function app_activity_info($id)
    {
        ...
        return $this->field('id,type,host_id,img,name,start_time,end_time,place,contact,phone,detail')->where('id=' . $id)->select();
    }
    ...
    public function count_time($host_id, $start_time, $end_time)
    {
        if ($host_id !== 0) {
    ...
    public function get_list_by_time($host_id, $start_time, $end_time, $page = '1,10', $fields = null)
    {
        if ($host_id !== 0) {
            $condition['host_id'] = $host_id;
        }
