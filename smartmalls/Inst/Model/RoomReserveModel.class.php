...
//        $condition['state'] = 1;
    ...
    public function getRoomReserveInfoByRoom($institution_id,$course_id,$room_number)
    {
        $condition['institution_id'] = $institution_id;
        $condition['course_id']=$course_id;
        $condition['room_number']=$room_number;
        return $this->where($condition)->find();
    }
    public function getRoomReserveInfoById($id)
    {
